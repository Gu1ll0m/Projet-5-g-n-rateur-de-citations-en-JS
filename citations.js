...
// Création de la variable Citation avec 3 ou 4 variables
  var Citation = {
    init: function (randomDebut, randomMilieu, randomMilieu2, randomFin) {
      ...
      if (randomMilieu2){this.randomMilieu2 = randomMilieu2;} // si 4 variables
  	},
   // Renvoie la description de Citation avec 3 ou 4 variables
   decrire: function () {
     if (this.randomMilieu2){
       return (this.randomDebut + " " + this.randomMilieu + " " + this.randomMilieu2 + " " + this.randomFin);
     } // si 4 variables
     else return (this.randomDebut + " " + this.randomMilieu + " " + this.randomFin); // si 3 variables
   },
 };
 ...
 function generate_citation(max, type){ // bonne pratique car fonction réutilisable
 	var tab = [];
 	for (var i = 0; i < max; i++) {
 		var citation = Object.create(Citation); // creation de la citation
    if (type == 3) { // si type =3 alors la citation aura cette forme
    citation.init(debut[generate_random(13)], milieu[[generate_random(13)]], null,fin[[generate_random(13)]]); // citation à 3 variables
    }
    else if (type == 4) { // si type =4 alors la citation aura cette forme
    citation.init(debut[generate_random(13)], milieu[[generate_random(13)]], milieu2[[generate_random(13)]],fin[[generate_random(13)]]); // citation à 4 variables
    }
 ...
 var proposition; // variable proposition => 5 choix possibles, générer de 1 à 5 citations
 while (proposition !== "0") {
    ...
    if((proposition>=0) && (proposition <=5)){ // proposition saisie par l' utilisateur est compris entre 1 et 5
      var typeCitation = prompt("Saississez 3 pour une (des) citation(s) à 3 variables, 4 pour 4 variables :"); // choix du nombre de variables
        if (typeCitation == 3 || typeCitation == 4) { // 2 choix possibles : générer 1 ou plusieurs citations à 3 (saisir 3) ou 4 (saisir 4) variables
        ...
        else { // si l'utilisateur choisit autre chose que 3 ou 4 variables (chiffre autre que 3 ou 4, lettre,....)
